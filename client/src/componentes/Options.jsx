...
const Options = ({ children }) => {
    const { me, name, setName, callAccepted, leaveCall, callUser, callEnded } = useContext(SocketContext)
                            ...
                            <TextField label="ID to Call" value={idTOCall} onChange={(e) => setIdToCall(e.target.value)} fullWidth></TextField>
                            {
                                callAccepted && !callEnded ? (
                                    <Button
                                        variant="contained"
                                        color="secondary"
                                        startIcon={<PhoneDisabled fontSize="large"></PhoneDisabled>}
                                        fullWidth
                                        onClick={leaveCall}
                                    ...
                                    <Button
                                        variant="contained"
                                        color="primary"
                                        startIcon={<Phone fontSize="large"></Phone>}
                                        fullWidth
